...
echo "Current Semester: " . $quarter;//quarter should be named semester but since you cannot see another quarter name in the entire code, just reserve the semester to other useful naming convention
